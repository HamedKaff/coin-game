...
public class CoinImpl implements Coin{
	...
	// returns the string qith method mixed case bwgin called to convert the string to lower case 
	@Override
	public String toString() {
		//return "Coin 1: "  + ", " + "Coin 2: " + getCoin2();
		 return "Coin " + this.number + ": " + MixedCase(this.face.toString());
		     //  "Coin " + this.number + ": " + MixedCase(this.face.toString()) ;
